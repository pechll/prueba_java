...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            //Instanciadno controlador
            BussinesLogic.clsLogin obBLBlLogin = new BussinesLogic.clsLogin();
                    
            //Invoco al método Validar Login
            boolean blBandera = obBLBlLogin.validaLogin(obclsLogin);
            
            if (blBandera)
                //Direcccionamiento JSO
